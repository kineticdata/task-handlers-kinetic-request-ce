...
class KineticRequestCeNotificationTemplateSendV2
  ...
  def getNotificationRecord(templateName)
    ...
    route =  "#{server}/app/api/v1/datastore/forms/notification-data/submissions" +
...
LOGGING
  ...
  def getDateFormats()
    ...
    begin
      ...
      date_format_api_route = "#{server}/app/api/v1/datastore/forms/notification-template-dates/submissions" +
