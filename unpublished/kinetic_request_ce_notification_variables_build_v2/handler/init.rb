...
class KineticRequestCeNotificationVariablesBuildV2
  ...
  def execute
    ...
    begin
      ...
      is_datastore    = @parameters["is_datastore"]
      ...
      if !submission_id.nil?
        if is_datastore == "Yes"
          data_api_route = api_route + "datastore/submissions/#{submission_id}?include=details,values,form,form.attributes,form.space,form.space.attributes"
        else
