...
class KineticRequestCeSubmissionRetrieveAssociatedAttributesV1
  ...
  def execute
    ...
    api_route = "#{api_server}/#{space_slug}/app/api/v1/submissions/#{submission_id}/?include=values,form,form.attributes,form.kapp,form.kapp.attributes,form.kapp.space,form.kapp.space.attributes"
